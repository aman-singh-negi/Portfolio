export const projects = [
  {
    ...
    description: "Deep Q-Network agent for lunar lander control using reinforcement learning.",
    ...
    detailedDescription: "Lunar Landing Module using Deep Learning and Neural Networks is a Deep Reinforcement Learning project that trains an agent to control a lunar lander in the Gymnasium LunarLander-v3 simulation. The agent uses a Deep Q-Network (DQN) to estimate Q-values for possible actions and learns an effective landing policy through trial-and-error and reward feedback. Double DQN, experience replay, target networks, epsilon-greedy exploration, reward clipping, and Huber loss are used to improve training stability and decision-making. The model was trained for 2000 episodes and achieved a peak average reward of approximately 58."
  },
  {
    slug: "institutional-inspection",
    title: "AI-Driven Institutional Inspection System (SIH FINAL)",
    description: "Multi-modal AI platform for automated institutional inspection and compliance analysis.",
  ...
  },
  {
    ...
    detailedDescription: "Built a client-side file encryption tool using JavaScript, supporting secure upload, encryption, and decryption. The application ensures privacy by processing files entirely in the browser without server-side storage, using FileReader and Blob APIs for file handling with symmetric encryption for optimal performance."
  },
  {
    slug: "drowsiness-detection",
    title: "Drowsiness Detection System",
    description: "Real-time driver monitoring system using CNN-based eye-state classification with 95.4% accuracy.",
